            ...
            >
              <div className="overflow-hidden border border-border bg-background">
                ...
                <img
                  ...
                  className="aspect-square w-full bg-muted object-contain p-4 mix-blend-multiply dark:mix-blend-normal"
                />
        ...
        <div className="relative mx-auto w-full max-w-xs md:hidden">
          <div className="overflow-hidden border border-border bg-background">
            ...
            <img
              ...
              className="aspect-square w-full bg-muted object-contain p-5 mix-blend-multiply dark:mix-blend-normal"
            />

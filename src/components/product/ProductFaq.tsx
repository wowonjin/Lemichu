...
const faqItems: FaqItem[] = [
  ...
  {
    q: "적립금은 언제 받나요?",
    a: <>적립금은 <strong className="font-semibold text-foreground">계좌이체·무통장 입금</strong>의 실제 결제액(적립금 사용 후) 1%가 지급됩니다. 카드 결제에는 적립되지 않으며, 구매 확정 후 리뷰를 작성하면 텍스트 100원, 사진 포함 시 500원이 추가로 적립됩니다.</>,
  },
  {
    q: "관부가세가 발생하나요?",

...
const saleMethods = [
  {
    title: "빠른 판매",
    description: "시세 확인 후 바로 판매 가능한 방식입니다.",
    href: "/sell/estimate",
  },
  {
    title: "위탁 판매",
        ...
        <div className="grid gap-8 border-b border-border pb-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">
              사진을 등록하면 예상 시세를 확인하고, 검수 후 판매와 정산까지 진행할 수 있습니다.
              불필요한 장식보다 접수와 진행 상태를 명확하게 볼 수 있도록 구성했습니다.
            </p>
          ...
          <div className="border-y border-border py-5">
            ...
            <dl className="mt-4 space-y-3 text-sm">
              <InfoRow label="접수 방식" value="사진 업로드 후 상담" />
              <InfoRow label="예상가 안내" value="실거래가 기반 산정" />
              <InfoRow label="정산 방식" value="판매 완료 후 계좌 정산" />
            </dl>
          </div>
        </div>
          ...
          <aside className="space-y-8 lg:sticky lg:top-36 lg:self-start">
            ...
            <section className="border-y border-border py-5">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
                <li>상품 전체, 하자 부위, 구성품 사진을 함께 준비해 주세요.</li>
                <li>정품 확인이 어려운 상품은 접수가 제한될 수 있습니다.</li>
                <li>최종 판매가는 검수 결과와 시장 시세에 따라 달라질 수 있습니다.</li>
              </ul>
            </section>
          </aside>
        </div>
